...
fixed point, a looped or recurrent-depth transformer unrolling until
done --- and let harder inputs consume more computation. % TODO cite: Bai et al. 2019 (DEQ); ACT/PonderNet; Huginn/Ouro/TRM.
...
can safely iterate. % TODO cite: HNN, SympNets, port-Hamiltonian learning.
...
% ^ create the repo under this name (or update the URL) before submission.
